                ...
                <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;">
                        ...
                        @foreach ($grains as $grain)
                            <div class="col">
                                <div class="card h-100 shadow-sm">
                                    <img src="{{ asset($grain['url_images']) }}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <div class="clearfix mb-3"> <span
                                                class="float-start badge rounded-pill bg-primary">{{ $grain['name_product'] }}</span>
                                            <span class="float-end price-hp"
                                                style="color: green">{{ $grain['unit_price'] }} MAD;</span> </div>
                                        <h5 class="card-title">Article</h5>
                                        <div class="text-center my-4"> <a href="/ajoutProduit/id-{{ $grain['id'] }}"
                                                class="btn btn-warning">ADD To Shopp</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-block bg-white h-100 text-center p-5 pb-lg-0">
                                        <p></p>
                                        <img class="img-fluid" src="{{ asset('pack/img/fuetures.jpg') }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="row gx-5">
                                        ...
                                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                                            ...
                                            <div class="d-flex flex-column justify-content-start">
                                                <a class="text-white mb-2" href="/grain"><i
                                                        class="bi bi-arrow-right text-white me-2"></i>Grain</a>
                                                <a class="text-white mb-2" href="/herbicide"><i
                                                        class="bi bi-arrow-right text-white me-2"></i>herbicide</a>
                                                <a class="text-white mb-2" href="/phosphat"><i
                                                        class="bi bi-arrow-right text-white me-2"></i>phosphat</a>
                    ...
                    <div class="container-fluid bg-dark text-white py-4">
                        <div class="container text-center">
                            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">Agro Vision
                                </a>.Copright 2023 <a class="text-secondary fw-bold" href="https://htmlcodex.com"></a>
                            </p>
                        </div>
