           ...
           <main> <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;"> 
            <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3"> 
                ...
                <div class="col"> <div class="card h-100 shadow-sm"> 
                    ...
                    <div class="card-body"> <div class="clearfix mb-3"> <span class="float-start badge rounded-pill bg-primary">{{ $grain['name_product']}}</span> <span class="float-end price-hp" style="color: green">{{ $grain['unit_price']}} MAD;</span> </div> <h5 class="card-title">Article</h5> 
