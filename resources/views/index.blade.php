...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div style="">
                <a href="/show">
                    <i class="fa badgee fa-lg" value="{{$count}}" style="color: black">&#xf218;</i>
                ...
                <div class="carousel-item active">
                    ...
                    <div
                        ...
                        <div class="text-start p-5" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-black mb-md-4 ">Good grain for better Yield</h1>
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0"><a class="text-secondary fw-bold" href="#">Agro Vision </a>.Copright 2023
                <a class="text-secondary fw-bold" href="https://htmlcodex.com"></a></p>
        </div>
